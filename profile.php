...
<head>
  ...
  <title>DB Creation | User Profile</title>
                      ...
                      <div class="panel-body">
                       ...
                       <div class="col-md-8 col-xs-12 col-sm-6 col-lg-8" >
                        <div class="container" >
                          ...
                          <p>an   <b> <?php echo $_SESSION['type']?></b></p>
                          

                        </div>
                        <hr>
                        <ul class="container details" >
                          <li><p><span class="glyphicon glyphicon-user one" style="width:50px;"></span><?php echo $_SESSION['user']?></p></li>
